...
describe("Test TodoApp fonctionnement", function () {
    ...
    it("Contient la chaine de 'Nouvelle tâche'", () => {
        const div = document.createElement("div");
        ReactDOM.render(<TodoApp />, div);
    ...
    it("Saisie une valuer dans l'input, clique sur le bouton et vérifie que le texte est dans la liste", () => {
